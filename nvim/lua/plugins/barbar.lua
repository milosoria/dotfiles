local function init()
    local ok1, nvim_tree_view = pcall(require, "nvim-tree.view")
    local ok2, nvim_tree_events = pcall(require, "nvim-tree.events")
    local ok3, bufferline_api = pcall(require, "bufferline.api")
    ...
    map("n", "<leader>bqh", "<Cmd>BufferCloseBuffersLeft<CR>", opts)
    map("n", "<leader>bql", "<Cmd>BufferCloseBuffersRight<CR>", opts)
